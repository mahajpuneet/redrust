...
extern "C" {
    ...
    fn deleteExpiredKeyAndPropagate(db: *mut redisDb, keyobj: *mut robj);
...
#[no_mangle]
pub unsafe extern "C" fn activeExpireCycleTryExpire(
    mut db: *mut redisDb,
    mut de: *mut dictEntry,
    mut now: libc::c_longlong,
) -> libc::c_int {
    let mut t: libc::c_longlong = (*de).v.s64 as libc::c_longlong;
    if now > t {
...
#[no_mangle]
pub unsafe extern "C" fn activeExpireCycle(mut type_0: libc::c_int) {
    let mut effort: libc::c_ulong = (server.active_expire_effort - 1 as libc::c_int)
        as libc::c_ulong;
    let mut config_keys_per_loop: libc::c_ulong = (20 as libc::c_int as libc::c_ulong)
        .wrapping_add(
            ((20 as libc::c_int / 4 as libc::c_int) as libc::c_ulong)
                .wrapping_mul(effort),
        );
    let mut config_cycle_fast_duration: libc::c_ulong = (1000 as libc::c_int
        as libc::c_ulong)
        .wrapping_add(
            ((1000 as libc::c_int / 4 as libc::c_int) as libc::c_ulong)
                .wrapping_mul(effort),
        );
    let mut config_cycle_slow_time_perc: libc::c_ulong = (25 as libc::c_int
        as libc::c_ulong)
        .wrapping_add((2 as libc::c_int as libc::c_ulong).wrapping_mul(effort));
    let mut config_cycle_acceptable_stale: libc::c_ulong = (10 as libc::c_int
        as libc::c_ulong)
        .wrapping_sub(effort);
    static mut current_db: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    static mut timelimit_exit: libc::c_int = 0 as libc::c_int;
    static mut last_fast_cycle: libc::c_longlong = 0 as libc::c_int as libc::c_longlong;
    ...
    if type_0 == 1 as libc::c_int {
        if timelimit_exit == 0
            && server.stat_expired_stale_perc
                < config_cycle_acceptable_stale as libc::c_double
        {
            return;
        }
        if start
            < last_fast_cycle
                + config_cycle_fast_duration as libc::c_longlong
    ...
    timelimit = config_cycle_slow_time_perc
        ...
        .wrapping_div(server.hz as libc::c_ulong)
        .wrapping_div(100 as libc::c_int as libc::c_ulong) as libc::c_longlong;
    timelimit_exit = 0 as libc::c_int;
    if timelimit <= 0 as libc::c_int as libc::c_longlong {
        timelimit = 1 as libc::c_int as libc::c_longlong;
    }
    if type_0 == 1 as libc::c_int {
        timelimit = config_cycle_fast_duration as libc::c_longlong;
    }
    let mut total_sampled: libc::c_long = 0 as libc::c_int as libc::c_long;
    let mut total_expired: libc::c_long = 0 as libc::c_int as libc::c_long;
    if server.also_propagate.numops == 0 as libc::c_int {} else {
        _serverAssert(
            b"server.also_propagate.numops == 0\0" as *const u8 as *const libc::c_char,
            b"expire.c\0" as *const u8 as *const libc::c_char,
            187 as libc::c_int,
        );
        unreachable!();
    };
    ...
    j = 0 as libc::c_int;
    while j < dbs_per_call && timelimit_exit == 0 as libc::c_int {
        let mut expired: libc::c_ulong = 0;
        let mut sampled: libc::c_ulong = 0;
        let mut db: *mut redisDb = (server.db)
            .offset(current_db.wrapping_rem(server.dbnum as libc::c_uint) as isize);
        current_db = current_db.wrapping_add(1);
        loop {
            let mut num: libc::c_ulong = 0;
            let mut slots: libc::c_ulong = 0;
            let mut now: libc::c_longlong = 0;
            let mut ttl_sum: libc::c_longlong = 0;
            let mut ttl_samples: libc::c_int = 0;
            iteration += 1;
            num = ((*(*db).expires).ht_used[0 as libc::c_int as usize])
                .wrapping_add((*(*db).expires).ht_used[1 as libc::c_int as usize]);
            if num == 0 as libc::c_int as libc::c_ulong {
                (*db).avg_ttl = 0 as libc::c_int as libc::c_longlong;
                break;
            } else {
                slots = (if (*(*db).expires).ht_size_exp[0 as libc::c_int as usize]
                ...
                now = mstime();
                if slots > ((1 as libc::c_int) << 2 as libc::c_int) as libc::c_ulong
                    && num
                        .wrapping_mul(100 as libc::c_int as libc::c_ulong)
                        .wrapping_div(slots) < 1 as libc::c_int as libc::c_ulong
                {
                    break;
                }
                expired = 0 as libc::c_int as libc::c_ulong;
                sampled = 0 as libc::c_int as libc::c_ulong;
                ttl_sum = 0 as libc::c_int as libc::c_longlong;
                ttl_samples = 0 as libc::c_int;
                if num > config_keys_per_loop {
                    num = config_keys_per_loop;
                }
                let mut max_buckets: libc::c_long = num
                    .wrapping_mul(20 as libc::c_int as libc::c_ulong) as libc::c_long;
                let mut checked_buckets: libc::c_long = 0 as libc::c_int as libc::c_long;
                while sampled < num && checked_buckets < max_buckets {
                    let mut table: libc::c_int = 0 as libc::c_int;
                    while table < 2 as libc::c_int {
                        if table == 1 as libc::c_int
                            && !((*(*db).expires).rehashidx
                                != -(1 as libc::c_int) as libc::c_long)
                        {
                            break;
                        }
                        let mut idx: libc::c_ulong = (*db).expires_cursor;
                        idx
                            &= if (*(*db).expires).ht_size_exp[table as usize]
                                as libc::c_int == -(1 as libc::c_int)
                            {
                                0 as libc::c_int as libc::c_ulong
                            } else {
                                    ...
                                    as libc::c_int == -(1 as libc::c_int)
                                {
                                    ...
                                    (1 as libc::c_int as libc::c_ulong)
                                        << (*(*db).expires).ht_size_exp[table as usize]
                                            as libc::c_int
                                })
                                    .wrapping_sub(1 as libc::c_int as libc::c_ulong)
                            };
                        let mut de: *mut dictEntry = *((*(*db).expires)
                            .ht_table[table as usize])
                            .offset(idx as isize);
                        let mut ttl: libc::c_longlong = 0;
                        checked_buckets += 1;
                        while !de.is_null() {
                            let mut e: *mut dictEntry = de;
                            de = (*de).next;
                            ttl = (*e).v.s64 as libc::c_longlong - now;
                            if activeExpireCycleTryExpire(db, e, now) != 0 {
                                expired = expired.wrapping_add(1);
                            }
                    ...
                    (*db).expires_cursor = ((*db).expires_cursor).wrapping_add(1);
                }
                total_expired = (total_expired as libc::c_ulong).wrapping_add(expired)
                    as libc::c_long as libc::c_long;
                total_sampled = (total_sampled as libc::c_ulong).wrapping_add(sampled)
                    as libc::c_long as libc::c_long;
                if ttl_samples != 0 {
                    let mut avg_ttl: libc::c_longlong = ttl_sum
                        / ttl_samples as libc::c_longlong;
                    if (*db).avg_ttl == 0 as libc::c_int as libc::c_longlong {
                        (*db).avg_ttl = avg_ttl;
                    }
                    (*db)
                        .avg_ttl = (*db).avg_ttl / 50 as libc::c_int as libc::c_longlong
                        * 49 as libc::c_int as libc::c_longlong
                        + avg_ttl / 50 as libc::c_int as libc::c_longlong;
                }
                if iteration & 0xf as libc::c_int == 0 as libc::c_int {
                    elapsed = ustime() - start;
                    if elapsed > timelimit {
                        timelimit_exit = 1 as libc::c_int;
                        server.stat_expired_time_cap_reached_count += 1;
                        break;
                    }
                }
                if !(sampled == 0 as libc::c_int as libc::c_ulong
                    || expired
                        .wrapping_mul(100 as libc::c_int as libc::c_ulong)
                        .wrapping_div(sampled) > config_cycle_acceptable_stale)
                {
                    break;
                }
            }
    ...
    if server.latency_monitor_threshold != 0
        && elapsed / 1000 as libc::c_int as libc::c_longlong
            >= server.latency_monitor_threshold
    {
        latencyAddSample(
            b"expire-cycle\0" as *const u8 as *const libc::c_char,
            elapsed / 1000 as libc::c_int as libc::c_longlong,
        );
    }
    let mut current_perc: libc::c_double = 0.;
    if total_sampled != 0 {
        current_perc = total_expired as libc::c_double / total_sampled as libc::c_double;
    } else {
        current_perc = 0 as libc::c_int as libc::c_double;
    }
    server
        .stat_expired_stale_perc = current_perc * 0.05f64
        + server.stat_expired_stale_perc * 0.95f64;
}
#[no_mangle]
pub static mut slaveKeysWithExpire: *mut dict = 0 as *const dict as *mut dict;
#[no_mangle]
pub unsafe extern "C" fn expireSlaveKeys() {
    if slaveKeysWithExpire.is_null()
        || ((*slaveKeysWithExpire).ht_used[0 as libc::c_int as usize])
            .wrapping_add((*slaveKeysWithExpire).ht_used[1 as libc::c_int as usize])
            == 0 as libc::c_int as libc::c_ulong
    {
        return;
    }
    let mut cycles: libc::c_int = 0 as libc::c_int;
    let mut noexpire: libc::c_int = 0 as libc::c_int;
    let mut start: mstime_t = mstime();
    loop {
        let mut de: *mut dictEntry = dictGetRandomKey(slaveKeysWithExpire);
        let mut keyname: sds = (*de).key as sds;
        let mut dbids: uint64_t = (*de).v.u64_0;
        let mut new_dbids: uint64_t = 0 as libc::c_int as uint64_t;
        let mut dbid: libc::c_int = 0 as libc::c_int;
        while dbids != 0 && dbid < server.dbnum {
            if dbids & 1 as libc::c_int as libc::c_ulong
                != 0 as libc::c_int as libc::c_ulong
            {
                let mut db: *mut redisDb = (server.db).offset(dbid as isize);
                let mut expire: *mut dictEntry = dictFind(
                    (*db).expires,
                ...
                if !expire.is_null()
                    && activeExpireCycleTryExpire(
                        (server.db).offset(dbid as isize),
                        expire,
                        start,
                    ) != 0
                {
                ...
                if !expire.is_null() && expired == 0 {
                    noexpire += 1;
                    new_dbids |= (1 as libc::c_int as uint64_t) << dbid;
                }
            }
            dbid += 1;
            dbids >>= 1 as libc::c_int;
        }
        if new_dbids != 0 {
            (*de).v.u64_0 = new_dbids;
        } else {
            dictDelete(slaveKeysWithExpire, keyname as *const libc::c_void);
        }
        cycles += 1;
        if noexpire > 3 as libc::c_int {
            break;
        }
        if cycles % 64 as libc::c_int == 0 as libc::c_int
            && mstime() - start > 1 as libc::c_int as libc::c_longlong
        {
            break;
        }
        if ((*slaveKeysWithExpire).ht_used[0 as libc::c_int as usize])
            .wrapping_add((*slaveKeysWithExpire).ht_used[1 as libc::c_int as usize])
            == 0 as libc::c_int as libc::c_ulong
        {
            break;
...
#[no_mangle]
pub unsafe extern "C" fn rememberSlaveKeyWithExpire(
    mut db: *mut redisDb,
    mut key: *mut robj,
) {
    if slaveKeysWithExpire.is_null() {
        static mut dt: dictType = unsafe {
            {
        ...
        slaveKeysWithExpire = dictCreate(&mut dt);
    }
    if (*db).id > 63 as libc::c_int {
        return;
    }
    let mut de: *mut dictEntry = dictAddOrFind(slaveKeysWithExpire, (*key).ptr);
    if (*de).key == (*key).ptr {
        (*de).key = sdsdup((*key).ptr as sds) as *mut libc::c_void;
        (*de).v.u64_0 = 0 as libc::c_int as uint64_t;
    }
    let mut dbids: uint64_t = (*de).v.u64_0;
    dbids |= (1 as libc::c_int as uint64_t) << (*db).id;
    (*de).v.u64_0 = dbids;
}
#[no_mangle]
pub unsafe extern "C" fn getSlaveKeyWithExpireCount() -> size_t {
    if slaveKeysWithExpire.is_null() {
        return 0 as libc::c_int as size_t;
    }
    return ((*slaveKeysWithExpire).ht_used[0 as libc::c_int as usize])
        .wrapping_add((*slaveKeysWithExpire).ht_used[1 as libc::c_int as usize]);
}
#[no_mangle]
pub unsafe extern "C" fn flushSlaveKeysWithExpireList() {
    if !slaveKeysWithExpire.is_null() {
        dictRelease(slaveKeysWithExpire);
        slaveKeysWithExpire = 0 as *mut dict;
    }
}
#[no_mangle]
pub unsafe extern "C" fn checkAlreadyExpired(mut when: libc::c_longlong) -> libc::c_int {
    return (when <= mstime() && server.loading == 0 && (server.masterhost).is_null())
        as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn parseExtendedExpireArgumentsOrReply(
    mut c: *mut client,
    ...
    while j < (*c).argc {
        ...
        if strcasecmp(opt, b"nx\0" as *const u8 as *const libc::c_char) == 0 {
            ...
            *flags |= (1 as libc::c_int) << 2 as libc::c_int;
            gt = 1 as libc::c_int;
        } else if strcasecmp(opt, b"lt\0" as *const u8 as *const libc::c_char) == 0 {
            *flags |= (1 as libc::c_int) << 3 as libc::c_int;
            lt = 1 as libc::c_int;
        } else {
            addReplyErrorFormat(
                c,
                b"Unsupported option %s\0" as *const u8 as *const libc::c_char,
                opt,
            );
            return -(1 as libc::c_int);
        }
    ...
    if nx != 0 && xx != 0 || nx != 0 && gt != 0 || nx != 0 && lt != 0 {
        addReplyError(
            c,
            b"NX and XX, GT or LT options at the same time are not compatible\0"
    ...
    if gt != 0 && lt != 0 {
        addReplyError(
            c,
            b"GT and LT options at the same time are not compatible\0" as *const u8
...
#[no_mangle]
pub unsafe extern "C" fn expireGenericCommand(
    mut c: *mut client,
    mut basetime: libc::c_longlong,
    mut unit: libc::c_int,
) {
    let mut key: *mut robj = *((*c).argv).offset(1 as libc::c_int as isize);
    let mut param: *mut robj = *((*c).argv).offset(2 as libc::c_int as isize);
    let mut when: libc::c_longlong = 0;
    let mut current_expire: libc::c_longlong = -(1 as libc::c_int) as libc::c_longlong;
    let mut flag: libc::c_int = 0 as libc::c_int;
    if parseExtendedExpireArgumentsOrReply(c, &mut flag) != 0 as libc::c_int {
        return;
    }
    if getLongLongFromObjectOrReply(c, param, &mut when, 0 as *const libc::c_char)
        != 0 as libc::c_int
    {
        return;
    }
    if unit == 0 as libc::c_int {
        ...
        when *= 1000 as libc::c_int as libc::c_longlong;
    }
    if when > 9223372036854775807 as libc::c_longlong - basetime {
        addReplyErrorExpireTime(c);
        return;
    }
    when += basetime;
    if (lookupKeyWrite((*c).db, key)).is_null() {
        addReply(c, shared.czero);
        return;
    }
    if flag != 0 {
        current_expire = getExpire((*c).db, key);
        if flag & (1 as libc::c_int) << 0 as libc::c_int != 0 {
            if current_expire != -(1 as libc::c_int) as libc::c_longlong {
                addReply(c, shared.czero);
                return;
            }
        }
        ...
        if flag & (1 as libc::c_int) << 2 as libc::c_int != 0 {
            if when <= current_expire
                || current_expire == -(1 as libc::c_int) as libc::c_longlong
            {
                addReply(c, shared.czero);
                return;
            }
        }
        if flag & (1 as libc::c_int) << 3 as libc::c_int != 0 {
            if current_expire != -(1 as libc::c_int) as libc::c_longlong
                && when >= current_expire
            {
                addReply(c, shared.czero);
    ...
    if checkAlreadyExpired(when) != 0 {
        let mut aux: *mut robj = 0 as *mut robj;
        ...
        server.dirty += 1;
        aux = if server.lazyfree_lazy_expire != 0 { shared.unlink } else { shared.del };
        rewriteClientCommandVector(c, 2 as libc::c_int, aux, key);
        ...
        addReply(c, shared.cone);
        if (*(*c).cmd).proc_0
            != Some(pexpireatCommand as unsafe extern "C" fn(*mut client) -> ())
        {
            rewriteClientCommandArgument(c, 0 as libc::c_int, shared.pexpireat);
        }
        if basetime != 0 as libc::c_int as libc::c_longlong || unit == 0 as libc::c_int {
            let mut when_obj: *mut robj = createStringObjectFromLongLong(when);
            rewriteClientCommandArgument(c, 2 as libc::c_int, when_obj);
...
#[no_mangle]
pub unsafe extern "C" fn expireCommand(mut c: *mut client) {
    expireGenericCommand(c, mstime(), 0 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn expireatCommand(mut c: *mut client) {
    expireGenericCommand(c, 0 as libc::c_int as libc::c_longlong, 0 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn pexpireCommand(mut c: *mut client) {
    expireGenericCommand(c, mstime(), 1 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn pexpireatCommand(mut c: *mut client) {
    expireGenericCommand(c, 0 as libc::c_int as libc::c_longlong, 1 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn ttlGenericCommand(
    mut c: *mut client,
    mut output_ms: libc::c_int,
    mut output_abs: libc::c_int,
) {
    let mut expire: libc::c_longlong = 0;
    let mut ttl: libc::c_longlong = -(1 as libc::c_int) as libc::c_longlong;
    if (lookupKeyReadWithFlags(
        ...
        *((*c).argv).offset(1 as libc::c_int as isize),
        ...
        .is_null()
    {
        addReplyLongLong(c, -(2 as libc::c_int) as libc::c_longlong);
        return;
    }
    expire = getExpire((*c).db, *((*c).argv).offset(1 as libc::c_int as isize));
    if expire != -(1 as libc::c_int) as libc::c_longlong {
        ttl = if output_abs != 0 { expire } else { expire - mstime() };
        if ttl < 0 as libc::c_int as libc::c_longlong {
            ttl = 0 as libc::c_int as libc::c_longlong;
        }
    }
    if ttl == -(1 as libc::c_int) as libc::c_longlong {
        ...
        addReplyLongLong(
            ...
            if output_ms != 0 {
                ...
                (ttl + 500 as libc::c_int as libc::c_longlong)
                    / 1000 as libc::c_int as libc::c_longlong
            },
        );
    };
...
#[no_mangle]
pub unsafe extern "C" fn ttlCommand(mut c: *mut client) {
    ttlGenericCommand(c, 0 as libc::c_int, 0 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn pttlCommand(mut c: *mut client) {
    ttlGenericCommand(c, 1 as libc::c_int, 0 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn expiretimeCommand(mut c: *mut client) {
    ttlGenericCommand(c, 0 as libc::c_int, 1 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn pexpiretimeCommand(mut c: *mut client) {
    ttlGenericCommand(c, 1 as libc::c_int, 1 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn persistCommand(mut c: *mut client) {
    if !(lookupKeyWrite((*c).db, *((*c).argv).offset(1 as libc::c_int as isize)))
        .is_null()
    {
...
#[no_mangle]
pub unsafe extern "C" fn touchCommand(mut c: *mut client) {
    let mut touched: libc::c_int = 0 as libc::c_int;
    let mut j: libc::c_int = 1 as libc::c_int;
    while j < (*c).argc {
        if !(lookupKeyRead((*c).db, *((*c).argv).offset(j as isize))).is_null() {
            touched += 1;
        }
        j += 1;
    }
    addReplyLongLong(c, touched as libc::c_longlong);
}
