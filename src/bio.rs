...
pub struct keySpec {
    ...
    pub bs: C2RustUnnamed_7,
    pub find_keys_type: kspec_fk_type,
    pub fk: C2RustUnnamed_4,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub union C2RustUnnamed_4 {
    pub range: C2RustUnnamed_6,
    pub keynum: C2RustUnnamed_5,
}
#[derive(Copy, Clone)]
#[repr(C)]
...
pub union C2RustUnnamed_7 {
    pub index: C2RustUnnamed_9,
    pub keyword: C2RustUnnamed_8,
}
#[derive(Copy, Clone)]
#[repr(C)]
...
pub struct redisServer {
    ...
    pub inst_metric: [C2RustUnnamed_10; 5],
...
#[repr(C)]
pub union bio_job {
    pub fd_args: C2RustUnnamed_12,
    pub free_args: C2RustUnnamed_11,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct C2RustUnnamed_11 {
    pub free_fn: Option::<lazy_free_fn>,
    pub free_args: [*mut libc::c_void; 0],
}
#[derive(Copy, Clone, c2rust_bitfields::BitfieldStruct)]
#[repr(C)]
pub struct C2RustUnnamed_12 {
    pub fd: libc::c_int,
    #[bitfield(name = "need_fsync", ty = "libc::c_uint", bits = "0..=0")]
    pub need_fsync: [u8; 1],
    #[bitfield(padding)]
    pub c2rust_padding: [u8; 3],
}
static mut bio_threads: [pthread_t; 3] = [0; 3];
static mut bio_mutex: [pthread_mutex_t; 3] = [pthread_mutex_t {
...
static mut bio_newjob_cond: [pthread_cond_t; 3] = [pthread_cond_t {
...
static mut bio_step_cond: [pthread_cond_t; 3] = [pthread_cond_t {
    __data: __pthread_cond_s {
        c2rust_unnamed: C2RustUnnamed_1 { __wseq: 0 },
        c2rust_unnamed_0: C2RustUnnamed { __g1_start: 0 },
        __g_refs: [0; 2],
...
static mut bio_jobs: [*mut list; 3] = [0 as *const list as *mut list; 3];
static mut bio_pending: [libc::c_ulonglong; 3] = [0; 3];
#[no_mangle]
pub unsafe extern "C" fn bioInit() {
    let mut attr: pthread_attr_t = pthread_attr_t { __size: [0; 64] };
    ...
    while j < 3 as libc::c_int {
        pthread_mutex_init(
            &mut *bio_mutex.as_mut_ptr().offset(j as isize),
            0 as *const pthread_mutexattr_t,
        );
        pthread_cond_init(
            &mut *bio_newjob_cond.as_mut_ptr().offset(j as isize),
            0 as *const pthread_condattr_t,
        );
        pthread_cond_init(
            &mut *bio_step_cond.as_mut_ptr().offset(j as isize),
            0 as *const pthread_condattr_t,
        );
        bio_jobs[j as usize] = listCreate();
        bio_pending[j as usize] = 0 as libc::c_int as libc::c_ulonglong;
        j += 1;
    }
    pthread_attr_init(&mut attr);
    pthread_attr_getstacksize(&mut attr, &mut stacksize);
    if stacksize == 0 {
        stacksize = 1 as libc::c_int as size_t;
    }
    while stacksize
        < (1024 as libc::c_int * 1024 as libc::c_int * 4 as libc::c_int) as libc::c_ulong
    {
        stacksize = (stacksize as libc::c_ulong)
            .wrapping_mul(2 as libc::c_int as libc::c_ulong) as size_t as size_t;
    }
    pthread_attr_setstacksize(&mut attr, stacksize);
    j = 0 as libc::c_int;
    while j < 3 as libc::c_int {
        let mut arg: *mut libc::c_void = j as libc::c_ulong as *mut libc::c_void;
        if pthread_create(
            &mut thread,
            &mut attr,
            Some(
        ...
        ) != 0 as libc::c_int
        {
            if !((3 as libc::c_int & 0xff as libc::c_int) < server.verbosity) {
                _serverLog(
                    3 as libc::c_int,
                    b"Fatal: Can't initialize Background Jobs.\0" as *const u8
                        as *const libc::c_char,
                );
            }
            exit(1 as libc::c_int);
        }
        bio_threads[j as usize] = thread;
        j += 1;
    }
}
#[no_mangle]
pub unsafe extern "C" fn bioSubmitJob(mut type_0: libc::c_int, mut job: *mut bio_job) {
    pthread_mutex_lock(&mut *bio_mutex.as_mut_ptr().offset(type_0 as isize));
    listAddNodeTail(bio_jobs[type_0 as usize], job as *mut libc::c_void);
    bio_pending[type_0 as usize] = (bio_pending[type_0 as usize]).wrapping_add(1);
    pthread_cond_signal(&mut *bio_newjob_cond.as_mut_ptr().offset(type_0 as isize));
    pthread_mutex_unlock(&mut *bio_mutex.as_mut_ptr().offset(type_0 as isize));
}
#[no_mangle]
pub unsafe extern "C" fn bioCreateLazyFreeJob(
    mut free_fn: Option::<lazy_free_fn>,
    mut arg_count: libc::c_int,
    mut args: ...
) {
    let mut valist: core::ffi::VaListImpl;
    let mut job: *mut bio_job = zmalloc(
        (core::mem::size_of::<bio_job>() as libc::c_ulong)
            .wrapping_add(
    ...
    while i < arg_count {
        let ref mut fresh0 = *((*job).free_args.free_args)
            .as_mut_ptr()
            .offset(i as isize);
        *fresh0 = valist.arg::<*mut libc::c_void>();
        i += 1;
    }
    bioSubmitJob(2 as libc::c_int, job);
}
#[no_mangle]
pub unsafe extern "C" fn bioCreateCloseJob(
    mut fd: libc::c_int,
    mut need_fsync: libc::c_int,
) {
    let mut job: *mut bio_job = zmalloc(
        core::mem::size_of::<bio_job>() as libc::c_ulong,
    ) as *mut bio_job;
    (*job).fd_args.fd = fd;
    ((*job).fd_args).set_need_fsync(need_fsync as libc::c_uint);
    bioSubmitJob(0 as libc::c_int, job);
}
#[no_mangle]
pub unsafe extern "C" fn bioCreateFsyncJob(mut fd: libc::c_int) {
    let mut job: *mut bio_job = zmalloc(
        core::mem::size_of::<bio_job>() as libc::c_ulong,
    ) as *mut bio_job;
    (*job).fd_args.fd = fd;
    bioSubmitJob(1 as libc::c_int, job);
}
#[no_mangle]
pub unsafe extern "C" fn bioProcessBackgroundJobs(
    mut arg: *mut libc::c_void,
) -> *mut libc::c_void {
    let mut job: *mut bio_job = 0 as *mut bio_job;
    let mut type_0: libc::c_ulong = arg as libc::c_ulong;
    let mut sigset: sigset_t = sigset_t { __val: [0; 16] };
    if type_0 >= 3 as libc::c_int as libc::c_ulong {
        if !((3 as libc::c_int & 0xff as libc::c_int) < server.verbosity) {
            _serverLog(
                3 as libc::c_int,
                b"Warning: bio thread started with wrong type %lu\0" as *const u8
                    as *const libc::c_char,
                type_0,
            );
        }
    ...
    match type_0 {
        0 => {
            pthread_setname_np(
                pthread_self(),
                b"bio_close_file\0" as *const u8 as *const libc::c_char,
            );
        }
        1 => {
            pthread_setname_np(
                pthread_self(),
                b"bio_aof_fsync\0" as *const u8 as *const libc::c_char,
            );
        }
        2 => {
            pthread_setname_np(
                pthread_self(),
                b"bio_lazy_free\0" as *const u8 as *const libc::c_char,
            );
        }
        _ => {}
    }
    ...
    sigaddset(&mut sigset, 14 as libc::c_int);
    if pthread_sigmask(0 as libc::c_int, &mut sigset, 0 as *mut __sigset_t) != 0 {
        if !((3 as libc::c_int & 0xff as libc::c_int) < server.verbosity) {
            _serverLog(
                3 as libc::c_int,
                b"Warning: can't mask SIGALRM in bio.c thread: %s\0" as *const u8
                    as *const libc::c_char,
    ...
    loop {
        ...
        if (*bio_jobs[type_0 as usize]).len == 0 as libc::c_int as libc::c_ulong {
            pthread_cond_wait(
                &mut *bio_newjob_cond.as_mut_ptr().offset(type_0 as isize),
                &mut *bio_mutex.as_mut_ptr().offset(type_0 as isize),
            );
        } else {
            ln = (*bio_jobs[type_0 as usize]).head;
            job = (*ln).value as *mut bio_job;
            pthread_mutex_unlock(&mut *bio_mutex.as_mut_ptr().offset(type_0 as isize));
            if type_0 == 0 as libc::c_int as libc::c_ulong {
                if ((*job).fd_args).need_fsync() != 0 {
                    fdatasync((*job).fd_args.fd);
                }
                close((*job).fd_args.fd);
            } else if type_0 == 1 as libc::c_int as libc::c_ulong {
                if fdatasync((*job).fd_args.fd) == -(1 as libc::c_int)
                    && *__errno_location() != 9 as libc::c_int
                    && *__errno_location() != 22 as libc::c_int
                {
                    let mut last_status: libc::c_int = 0;
                    last_status = core::intrinsics::atomic_load_relaxed(
                    ...
                    if last_status == 0 as libc::c_int {
                        if !((3 as libc::c_int & 0xff as libc::c_int) < server.verbosity)
                        {
                            _serverLog(
                                3 as libc::c_int,
            ...
            } else if type_0 == 2 as libc::c_int as libc::c_ulong {
                ((*job).free_args.free_fn)
                    .expect(
                        "non-null function pointer",
                    )(((*job).free_args.free_args).as_mut_ptr());
            } else {
                _serverPanic(
                    b"bio.c\0" as *const u8 as *const libc::c_char,
                    252 as libc::c_int,
                    b"Wrong job type in bioProcessBackgroundJobs().\0" as *const u8
                        as *const libc::c_char,
                );
                unreachable!();
            }
            zfree(job as *mut libc::c_void);
            pthread_mutex_lock(&mut *bio_mutex.as_mut_ptr().offset(type_0 as isize));
            listDelNode(bio_jobs[type_0 as usize], ln);
            bio_pending[type_0
                as usize] = (bio_pending[type_0 as usize]).wrapping_sub(1);
            pthread_cond_broadcast(
                &mut *bio_step_cond.as_mut_ptr().offset(type_0 as isize),
            );
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn bioPendingJobsOfType(
    mut type_0: libc::c_int,
) -> libc::c_ulonglong {
    let mut val: libc::c_ulonglong = 0;
    pthread_mutex_lock(&mut *bio_mutex.as_mut_ptr().offset(type_0 as isize));
    val = bio_pending[type_0 as usize];
    pthread_mutex_unlock(&mut *bio_mutex.as_mut_ptr().offset(type_0 as isize));
    return val;
}
#[no_mangle]
pub unsafe extern "C" fn bioWaitStepOfType(
    mut type_0: libc::c_int,
) -> libc::c_ulonglong {
    let mut val: libc::c_ulonglong = 0;
    pthread_mutex_lock(&mut *bio_mutex.as_mut_ptr().offset(type_0 as isize));
...
#[no_mangle]
pub unsafe extern "C" fn bioKillThreads() {
    let mut err: libc::c_int = 0;
    let mut j: libc::c_int = 0;
    j = 0 as libc::c_int;
    while j < 3 as libc::c_int {
        if !(bio_threads[j as usize] == pthread_self()) {
            if bio_threads[j as usize] != 0
                && pthread_cancel(bio_threads[j as usize]) == 0 as libc::c_int
            {
                err = pthread_join(bio_threads[j as usize], 0 as *mut *mut libc::c_void);
                if err != 0 as libc::c_int {
                    if !((3 as libc::c_int & 0xff as libc::c_int) < server.verbosity) {
                        _serverLog(
                            3 as libc::c_int,
                            b"Bio thread for job type #%d can not be joined: %s\0"
                ...
                } else if !((3 as libc::c_int & 0xff as libc::c_int) < server.verbosity)
                {
                    _serverLog(
                        3 as libc::c_int,
                        b"Bio thread for job type #%d terminated\0" as *const u8
                            as *const libc::c_char,
                        j,
                    );
                }
