...
#[no_mangle]
pub unsafe extern "C" fn tlsInit() {}
#[no_mangle]
pub unsafe extern "C" fn tlsCleanup() {}
#[no_mangle]
pub unsafe extern "C" fn tlsConfigure(
    mut ctx_config: *mut redisTLSContextConfig,
) -> libc::c_int {
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn connCreateTLS() -> *mut connection {
    return 0 as *mut connection;
}
#[no_mangle]
pub unsafe extern "C" fn connCreateAcceptedTLS(
    mut fd: libc::c_int,
    mut require_auth: libc::c_int,
) -> *mut connection {
    return 0 as *mut connection;
}
#[no_mangle]
pub unsafe extern "C" fn tlsHasPendingData() -> libc::c_int {
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn tlsProcessPendingData() -> libc::c_int {
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn connTLSGetPeerCert(mut conn_: *mut connection) -> sds {
    return 0 as sds;
}
