...
#[no_mangle]
pub unsafe extern "C" fn keyspaceEventsStringToFlags(
    mut classes: *mut libc::c_char,
) -> libc::c_int {
    let mut p: *mut libc::c_char = classes;
...
#[no_mangle]
pub unsafe extern "C" fn keyspaceEventsFlagsToString(mut flags: libc::c_int) -> sds {
    let mut res: sds = 0 as *mut libc::c_char;
    res = sdsempty();
    if flags
        & ((1 as libc::c_int) << 2 as libc::c_int
            | (1 as libc::c_int) << 3 as libc::c_int
            ...
            | (1 as libc::c_int) << 13 as libc::c_int
    {
        ...
        if flags & (1 as libc::c_int) << 2 as libc::c_int != 0 {
            res = sdscatlen(
                res,
                b"g\0" as *const u8 as *const libc::c_char as *const libc::c_void,
                1 as libc::c_int as size_t,
            );
        }
        ...
        if flags & (1 as libc::c_int) << 4 as libc::c_int != 0 {
            res = sdscatlen(
                res,
                b"l\0" as *const u8 as *const libc::c_char as *const libc::c_void,
                1 as libc::c_int as size_t,
            );
        }
        ...
        if flags & (1 as libc::c_int) << 6 as libc::c_int != 0 {
            res = sdscatlen(
                res,
                b"h\0" as *const u8 as *const libc::c_char as *const libc::c_void,
                1 as libc::c_int as size_t,
            );
        }
        ...
        if flags & (1 as libc::c_int) << 9 as libc::c_int != 0 {
            res = sdscatlen(
                res,
                b"e\0" as *const u8 as *const libc::c_char as *const libc::c_void,
                1 as libc::c_int as size_t,
            );
        }
        if flags & (1 as libc::c_int) << 10 as libc::c_int != 0 {
            res = sdscatlen(
                res,
                b"t\0" as *const u8 as *const libc::c_char as *const libc::c_void,
                1 as libc::c_int as size_t,
            );
        }
        if flags & (1 as libc::c_int) << 13 as libc::c_int != 0 {
            res = sdscatlen(
                res,
                b"d\0" as *const u8 as *const libc::c_char as *const libc::c_void,
                1 as libc::c_int as size_t,
            );
        }
    ...
    if flags & (1 as libc::c_int) << 0 as libc::c_int != 0 {
        res = sdscatlen(
            res,
            b"K\0" as *const u8 as *const libc::c_char as *const libc::c_void,
            1 as libc::c_int as size_t,
        );
    }
    ...
    if flags & (1 as libc::c_int) << 11 as libc::c_int != 0 {
        res = sdscatlen(
            res,
            b"m\0" as *const u8 as *const libc::c_char as *const libc::c_void,
            1 as libc::c_int as size_t,
        );
    }
    return res;
...
#[no_mangle]
pub unsafe extern "C" fn notifyKeyspaceEvent(
    mut type_0: libc::c_int,
    mut event: *mut libc::c_char,
    mut key: *mut robj,
    mut dbid: libc::c_int,
) {
    let mut chan: sds = 0 as *mut libc::c_char;
    let mut chanobj: *mut robj = 0 as *mut robj;
    let mut eventobj: *mut robj = 0 as *mut robj;
    let mut len: libc::c_int = -(1 as libc::c_int);
    let mut buf: [libc::c_char; 24] = [0; 24];
    moduleNotifyKeyspaceEvent(type_0, event, key, dbid);
    if server.notify_keyspace_events & type_0 == 0 {
        return;
    }
    eventobj = createStringObject(event, strlen(event));
    if server.notify_keyspace_events & (1 as libc::c_int) << 0 as libc::c_int != 0 {
        chan = sdsnewlen(
            b"__keyspace@\0" as *const u8 as *const libc::c_char as *const libc::c_void,
            11 as libc::c_int as size_t,
        );
        len = ll2string(
            buf.as_mut_ptr(),
            core::mem::size_of::<[libc::c_char; 24]>() as libc::c_ulong,
            dbid as libc::c_longlong,
        );
        chan = sdscatlen(chan, buf.as_mut_ptr() as *const libc::c_void, len as size_t);
        chan = sdscatlen(
            chan,
            b"__:\0" as *const u8 as *const libc::c_char as *const libc::c_void,
            3 as libc::c_int as size_t,
        );
        chan = sdscatsds(chan, (*key).ptr as sds);
        chanobj = createObject(0 as libc::c_int, chan as *mut libc::c_void);
        pubsubPublishMessage(chanobj, eventobj, 0 as libc::c_int);
        decrRefCount(chanobj);
    }
    if server.notify_keyspace_events & (1 as libc::c_int) << 1 as libc::c_int != 0 {
        chan = sdsnewlen(
            b"__keyevent@\0" as *const u8 as *const libc::c_char as *const libc::c_void,
            11 as libc::c_int as size_t,
        );
        ...
        chan = sdscatsds(chan, (*eventobj).ptr as sds);
        chanobj = createObject(0 as libc::c_int, chan as *mut libc::c_void);
        pubsubPublishMessage(chanobj, key, 0 as libc::c_int);
        decrRefCount(chanobj);
    }
